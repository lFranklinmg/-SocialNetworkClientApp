    ...
    return (
        <Segment.Group>
            ...
            <Segment clearing attached='bottom'>
                ...
                {activity.isHost ? (
                    <>
                        <Button color={activity.isCancelled ? 'green' : 'red'} floated='left' basic content={activity.isCancelled ? 'Re-activate' : 'Cancel'} onClick={cancelActivityToggle} loading={loading}>
                        </Button>
