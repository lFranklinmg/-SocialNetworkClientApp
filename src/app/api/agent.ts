...
const Activities = {
    //list: (params: URLSearchParams) => requests.get<PaginatedResult<Activity[]>>('/Activities'),
...
const Profiles = {
    ...
    listActivities: (username: string, predicate: string) => requests.get<UserActivity[]>(`/profiles/userActivities/${username}?predicate=${predicate}`)
